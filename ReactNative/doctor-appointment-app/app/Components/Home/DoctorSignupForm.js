...
// Validation Schema for Doctor Signup
...
const DoctorSignupForm = ({ onSignup }) => {
  const handleSignup = async (name, email, password, specialty, experience) => {
    try {
      const response = await axios.post(
        "http://localhost:3000/api/auth/doctor/signup",
        {
          name,
          email,
          password,
